...
<html lang="en" class="<?= Request::$route->controller ?> <?= Request::$route->controller_action ?>">
  <head>
      ...
      <link href="<?= asset('css/layouts/jumbotron.css') ?>" rel="stylesheet">
      ...
      <script src="<?= asset('js/layouts/jumbotron.js') ?>"></script>
  ...
  <body>
    ...
    <div class="container" id="navigation">
      <?= render('layouts.jumbotron.navbar') ?>
    </div>

    <div class="container" id="content">
      <?= render('layouts.jumbotron.carousel') ?>
