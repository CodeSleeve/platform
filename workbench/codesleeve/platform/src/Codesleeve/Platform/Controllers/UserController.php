...
class UserController extends BaseController
{
	 ...
	 */
	public function __construct(User $users, UserValidator $validator, Role $roles)
	{
		parent::__construct();
	...
	public function index()
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::users.index", compact('users'));
	}
	...
	public function create()
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::users.create", compact('user'));
	}
	...
	public function edit($id)
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::users.edit", compact('user'));
	}
