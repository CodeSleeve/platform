...
class RoleController extends BaseController
{
	 ...
	 * 
	 */
	public function __construct(Role $roles, RoleValidator $validator)
	{
		parent::__construct();
	...
	public function index()
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::roles.index", compact('roles'));
	}
	...
	public function create()
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::roles.create", compact('role'));
	}
	...
	public function store()
	{
		...
		return Redirect::action("{$this->namespace}\RoleController@index");
	}
	...
	public function edit($id)
	{
		...
		$this->layout->nest('content', "{$this->viewpath}::roles.edit", compact('role'));
	}
